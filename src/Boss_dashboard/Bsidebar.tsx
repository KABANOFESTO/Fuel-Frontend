    ...
    return (
        <>
            ...
            <Offcanvas
                ...
                className={`sidebar-width ${show ? "sidebar-expanded" : "sidebar-collapsed"}`}
...
const SidebarContent: React.FC<{
    ...
    return (
        <div className="d-flex flex-column bg-white h-100" style={{ width: '350px', padding: '150px 0' }}>
            {renderProfileSection()}

            <nav className="flex-grow-1 p-4">
                <ul className="list-unstyled mb-0">
                    {[
                        { to: "/boss/dashboard", label: "Dashboard", icon: "📊" },
                        { to: "/boss/reports", label: "Reports & Analysis", icon: "📈" }
                    ].map((item, index) => (
                ...
                <ul className="list-unstyled mb-0">
                    <li className="mb-3">
                        <Link
                            ...
                            style={{
                                fontSize: "1.1rem",
                                color: location.pathname === "/boss/profile" ? "#fff" : "#666",
                                backgroundColor:
                                    location.pathname === "/boss/profile" ? "#000" : "transparent",
                            }}
                        >
                            👤 Profile
                        </Link>
