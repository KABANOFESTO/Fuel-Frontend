...
const StationManagement: React.FC = () => {
    ...
    const handleCreateStation = async (e: React.FormEvent) => {
        ...
        setLoading(true);
        try {
            const response = await axiosInstance.post('/api/stations/create', formData);
    ...
    const handleUpdateStation = async (e: React.FormEvent) => {
        ...
        try {
            const response = await axiosInstance.put(
                `/api/stations/update/${currentStation.id}`,
                formData
            );
    ...
    const handleDeleteStation = async (id: number) => {
        ...
        setLoading(true);
        try {
            await axiosInstance.delete(`/api/stations/delete/${id}`);
